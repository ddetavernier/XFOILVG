...
C ### BEGIN: add vortex generator in write command
C ### DELPHINE/DANIEL CODE MODIFICATIONS - TIMESTAMP: 7 NOVEMBER 2017
C  
...
C
C ### DELPHINE/DANIEL CODE MODIFICATIONS - TIMESTAMP: 7 NOVEMBER 2017
C ### END: add vortex generator in write command
C ### DELPHINE/DANIEL CODE MODIFICATIONS - TIMESTAMP: 7 NOVEMBER 2017
C  
C
C======================================================================
...
C
C ### DELPHINE/DANIEL CODE MODIFICATIONS - TIMESTAMP: 7 NOVEMBER 2017
C ### BEGIN: add VG as possible command
C ### DELPHINE/DANIEL CODE MODIFICATIONS - TIMESTAMP: 7 NOVEMBER 2017
C  
 ...
 1050  FORMAT(
     ...
     &  /'   XVG  rr Include vortex generator'     
...
C
C ### DELPHINE/DANIEL CODE MODIFICATIONS - TIMESTAMP: 7 NOVEMBER 2017
C ### END: add VG as possible command
C ### DELPHINE/DANIEL CODE MODIFICATIONS - TIMESTAMP: 7 NOVEMBER 2017
C  
C--------------------------------------------------------------
...
C
C ### DELPHINE/DANIEL CODE MODIFICATIONS - TIMESTAMP: 7 NOVEMBER 2017
C ### BEGIN: Define VG properties
C ### DELPHINE/DANIEL CODE MODIFICATIONS - TIMESTAMP: 7 NOVEMBER 2017
C  

      ELSEIF(COMAND.EQ.'XVG ') THEN
       IF(LPACC .AND. LVISC) THEN
        WRITE(*,2100)
        GO TO 500
       ENDIF
       ...
       ELSE
        CALL ASKR('VG suction  side XVG/c^',XVG(1))
        CALL ASKR('VG pressure side XVG/c^',XVG(2))
        CALL ASKR('VG height HVG/c^', H_VG)
        CALL ASKR('VG length LVG/c^', W_VG)
        CALL ASKR('VG inflow angle deg^', Beta_VG)

       ENDIF
       LVCONV = .FALSE.
       
       IF(XVG(1)<XSTRIP(1)) THEN
       XSTRIP(1) = XVG(1)
       ENDIF

       IF(XVG(2)<XSTRIP(2)) THEN
       XSTRIP(2) = XVG(2)
       ENDIF
C
C ### DELPHINE/DANIEL CODE MODIFICATIONS - TIMESTAMP: 7 NOVEMBER 2017
C ### END: Define VG properties
C ### DELPHINE/DANIEL CODE MODIFICATIONS - TIMESTAMP: 7 NOVEMBER 2017
C  
C--------------------------------------------------------------
...
C----------------------------------------
      INCLUDE 'XFOIL.INC'
C
C---- convergence tolerance DELPHINE CHANGED
      DATA EPS1 / 1.0E-4 /
C
      NITER = NITER1
C
