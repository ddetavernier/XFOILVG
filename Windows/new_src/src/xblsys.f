...
C ### BEGIN: add source term to equilibrium shear coefficient
C ### DELPHINE/DANIEL CODE MODIFICATIONS - TIMESTAMP: 7 NOVEMBER 2017
...
C
      ...
      USB = 1.0 - US2
      CQ2     =
     &    SQRT( CTCON*HS2*HKB*HKC**2 / (USB*H2*HK2**2) ) + SOURCEVG
...
C
C ### DELPHINE/DANIEL CODE MODIFICATIONS - TIMESTAMP: 7 NOVEMBER 2017
C ### END: add source term to equilibrium shear coefficient
C ### DELPHINE/DANIEL CODE MODIFICATIONS - TIMESTAMP: 7 NOVEMBER 2017
C
