...
C..........................................
 1000 FORMAT(A)
     ...
     &                   CODE,VERSION, LQUERY )
      ...
      REAL CPOL(NAX,IPTOT), CPOLSD(NAX,ISX,JPTOT)
      REAL MACH1, ACRIT(ISX), XTRIP(ISX)
      REAL XVG(ISX), H_VG, W_VG, Beta_VG
...
C
       ...
       DO N = 1, NBL
         ...
         IF(NBL.EQ.1) THEN
          ...
          WRITE(LU,9013) XVG(IS1), XVG(IS2)
          WRITE(LU,9014) H_VG,W_VG,Beta_VG
         ELSE
...
C
      ...
      KF = KF + 1
C
C ### DELPHINE/DANIEL CODE MOFICATIONS - TIMESTAMP: MARCH 2016
C ### ERROR: EOF error due to compile incompatibilities, BUG No. 59513
C ### https://gcc.gnu.org/bugzilla/show_bug.cgi?id=59513
C ### DELPHINE/DANIEL CODE MOFICATIONS - TIMESTAMP: MARCH 2016
C
      BACKSPACE(LU)
      DO 40 IA = IA1, IA2
...
C......................................................................
 ...
 9013 FORMAT(1X,
     &'xvg   = ',F7.3,' (top)    ',F9.3,' (bottom)  ')
 9014 FORMAT(1X,
     &'hvg/c = ',F7.3,5X,' lvg/c = ',F7.3,5X,'Betavg = ',F7.3)
 9015 FORMAT(1X,
     &'Mach  = ',F7.3,5X,' Re    = ',F7.3,'e6',3X,'Ncrit  = ',20F7.3)
 9017 FORMAT(1X,
